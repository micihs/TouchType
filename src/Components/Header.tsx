  ...
  return (
    <header className="container">
      <nav className="header">
        ...
        >
          <p>
            <span className="header--blue site-title invisible">t</span>
            <span className="header--blue site-title invisible">o</span>
            <span className="header--blue site-title invisible">u</span>
            <span className="header--blue site-title invisible">c</span>
            <span className="header--blue site-title invisible">h</span>
            <span className="site-title invisible">t</span>
            <span className="site-title invisible">y</span>
